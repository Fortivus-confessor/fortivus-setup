        ...
        stage('Carregar secrets do Vault') {
            steps {
                withVault(
                    ...
                    vaultSecrets: [
                        [path: 'fortivus/database',   engineVersion: 1, secretValues: [
